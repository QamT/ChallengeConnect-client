...
export class ProfileCard extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={`profile__card ${side ? 'profile__card--right' : 'profile__card--left'}`}>
        <span className={`profile__card-arrow ${side ? 'profile__card-arrow--right' : 'profile__card-arrow--left'}`}>
